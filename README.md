...
## Release News
### Latest Release
This is an initial version with a Fire Sat example. This is a temporary release as we need to merge into our Teamwork Server to ensure there are no ID issues. 
https://github.com/ObjectManagementGroup/CSRM/tree/main/DistroTemp
### Original Release
